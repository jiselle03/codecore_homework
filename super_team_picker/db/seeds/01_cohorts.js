  ...
  return knex('cohorts').del()
    .then(function () {
      ...
      return knex('cohorts').insert([
        {name: 'Gryffindor', members: 'Hermione Granger, Harry Potter, Ronald Weasley, Ginny Weasley, Neville Longbottom, Seamus Finnigan, Dean Thomas, Fred Weasley, George Weasley', logoUrl: 'https://images-na.ssl-images-amazon.com/images/I/915wv-U37QL._SY606_.jpg'},
